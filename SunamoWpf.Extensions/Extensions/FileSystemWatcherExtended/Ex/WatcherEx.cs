namespace SunamoWpf.Extensions.FileSystemWatcherExtended.Ex;
    ...
    public class WatcherEx : IDisposable
    {
        ...
        public WatcherEx(WatcherInfo info)
        {
            if (info == null)
            {
                ThrowEx.Custom(Translate.FromKey(XlfKeys.WatcherInfoObjectCannotBeNull));
            }
    ...
    static Type type = typeof(WatcherEx);
        ...
        private void Initialize()
        {
            ...
            //////Debug.WriteLine(SHFormat.Format2("WatcherEx.Initialize() - {0} watchers created", this.watchers.Count));
        }
